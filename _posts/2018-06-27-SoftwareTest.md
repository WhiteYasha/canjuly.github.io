...
* 控制流图：唯一入口节点，唯一出口节点  
![avater](https://raw.githubusercontent.com/canjuly/canjuly.github.io/master/img/post-softwareTest-1.png)  
* 程序环路复杂度：V(G)
1. V(G) = 边数 - 节点数 + 2
2. V(G) = 判断节点 + 1
3. V(G) = 区域数目
...
* V模型  
![avater](https://raw.githubusercontent.com/canjuly/canjuly.github.io/master/img/post-softwareTest-2.png)
* 优化V模型采用W模型  
![avater](https://raw.githubusercontent.com/canjuly/canjuly.github.io/master/img/post-softwareTest-3.png)
